...
-- Toggle settings dengan tombol keyboard
...
print("Cyber Freeze Script loaded! Press 'F' to toggle settings")
print("Click the freeze button to freeze the game")
