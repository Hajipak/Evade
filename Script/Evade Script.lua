...
Tabs.Main:Button({
   ...
   -- Fluent tidak memiliki Section/Divider yang sama, bisa diakali dengan Paragraph
...
local TransparencySlider = Tabs.Settings:AddSlider("Transparency", {
    ...
    -- Settings for SaveManager (tambahkan di akhir script)
SaveManager:SetLibrary(Fluent)
InterfaceManager:SetLibrary(Fluent)
SaveManager:IgnoreThemeSettings()
SaveManager:SetIgnoreIndexes({})
InterfaceManager:SetFolder("FluentZenHub")
SaveManager:SetFolder("FluentZenHub/evade")
